...
SET MCU_FILE_NAME=USI216_TX_v1.2.2_Build230414.bin
...
SET MODEL_VERSION=2.1.20

::把jflash添加到路径里
set PATH_JFLASH=D:\Program Files (x86)\SEGGER\JLink
::把Gprogrammer添加到路径里
set PATH_GPROGRAMMER=D:\Program Files (x86)\Goodix\GProgrammer
